...
export default async function AscendProfile() {
  ...
  catch(error) {if(error instanceof ProfileStateError&&error.status===401)return <section className="panel"><h1>Your Ascend Profile</h1><p>Sign in to build your personal baseline with Aethelios.</p><Link href="/you">Your account →</Link></section>;throw error;}
